...
namespace GymCompetition
{
    public partial class AdminForm : Form
    {
        ...
        {
            teamBindingSource.DataSource = service.QueryAllTeams(); //teamBindingSource这里需要做链接
        }
        ...
        {
            AlterTable();
            teamBindingSource.DataSource = service.QueryAllTeams();//teamBindingSourcez这里需要做链接
